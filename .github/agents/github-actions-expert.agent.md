...
- Some workflows exist in `.github/workflows`, these are GitHub Agentic Workflows that you should ignore. 
- Other workflows in `sync/.github/workflows` are synced to other repositories and should be considered for customization and optimization.